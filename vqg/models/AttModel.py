...
class AttModel(VQGModel):
    def __init__(self, opt):
        ...
        self.iod_feat_size = opt.iod_feat_size
    ...
    def _prepare_feature(self, fc_feats, att_feats, att_masks):
        ...
        return fc_feats, att_feats, p_att_feats, att_masks # p_fc_feats, p_att_feats, pp_att_feats, p_att_masks
    ...
    # def _sample_beam(self, fc_feats, att_feats, iod_feats, answers, att_masks=None, iod_masks=None, opt={}):
    def _sample_beam(self, knowledges, fc_feats, att_feats, iod_feats, answers, att_masks, iod_masks, opt):
        # print(answers.shape)
        ...
        # print('sample_n ', sample_n, beam_size)

        p_fc_feats, p_att_feats, pp_att_feats, p_att_masks = self._prepare_feature(knowledges, fc_feats, att_feats, iod_feats, att_masks, iod_masks, answers)
    ...
    # def _sample(self, fc_feats, att_feats, iod_feats, answers, att_masks=None, iod_masks=None, opt={}):
    def _sample(self, knowledges, fc_feats, att_feats, iod_feats, answers, att_masks, iod_masks, opt):
        ...
        if beam_size > 1 and sample_method in ['greedy', 'beam_search']:
            return self._sample_beam(knowledges, fc_feats, att_feats, iod_feats, answers, att_masks, iod_masks, opt)
        if group_size > 1:
        ...
        p_fc_feats, p_att_feats, pp_att_feats, p_att_masks = self._prepare_feature(fc_feats, att_feats, iod_feats, att_masks, iod_masks, answers)
