...
def if_use_feat(vqg_model):
    if vqg_model in ["show_tell", "all_img", "fc", "newfc"]:
        use_att, use_fc = False, True
    elif vqg_model == "language_model":
        use_att, use_fc = False, False
    elif vqg_model in ["updown", "topdown"]:
...
def parse_opt():
    ...
    parser.add_argument(
        "--input_json",
        type=str,
        default="./data/OKVQA-info.json",
        help="path to the json file containing additional info and vocab",
    )
    parser.add_argument(
        "--input_id2QA",
        type=str,
        default="./data/OKVQA-id2QA.json",
        help="",
    )
    parser.add_argument(
        "--coco_h5",
        type=str,
        default="../pre-trained/faster-RCNN/genome-trainval.h5",
        help="",
    )
    parser.add_argument(
        "--augmented_image_folder",
        type=str,
        default="../VQA-Dataset/augmented",
        help="",
    )
    parser.add_argument(
        "--okvqa_train_kb",
        type=str,
        default="../VQG/Causal/knowledge/okvqa_train_kb_filter_v1_lower.json",
        help="",
    )
    parser.add_argument(
        "--okvqa_val_kb",
        type=str,
        default="../VQG/Causal/knowledge/okvqa_val_kb_filter_v1_lower.json",
        help="",
    )
    parser.add_argument(
        "--okvqa_train_annotations",
        type=str,
        default="../Dataset/OK-VQA/mscoco_train2014_annotations.json",
        help="",
    )
    parser.add_argument(
        "--okvqa_val_annotations",
        type=str,
        default="../Dataset/OK-VQA/mscoco_val2014_annotations.json",
        help="",
    )
    parser.add_argument(
        "--vqa20_train_annotations",
        type=str,
        default="../VQG/Causal/data/train2014_xu.json",
        help="",
    )
    parser.add_argument(
        "--vqa20_val_annotations",
        type=str,
        default="../VQG/Causal/data/val2014_xu.json",
        help="",
    )
    parser.add_argument(
        "--okvqa_knowledge_source",
        type=str,
        default="GPT-3",
        choices=["ConceptNet", "GPT-3"],
        help="",
    )
    parser.add_argument(
        "--okvqa_cn_kb_folder",
        type=str,
        default="../Dataset/OK-VQA/knowledge_txt",
        help="",
    )
    parser.add_argument(
        "--vqa20_knowledges_folder",
        type=str,
        default="../Dataset/VQA2.0/knowledges",
        help="",
    )
    parser.add_argument(
        "--enable_AFM", type=int, default=1, help=""  
    )
    parser.add_argument(
        "--enable_VD", type=int, default=1, help=""  
    )
    parser.add_argument("--loss_eff", type=int, default=1, help="")
    parser.add_argument("--lambda1", type=float, default=0.3, help="")
    parser.add_argument("--lambda2", type=float, default=0.5, help="")
    parser.add_argument(
        "--aug_feat_size", type=int, default=512, help=""  
    )
    parser.add_argument("--use_know", type=int, default=1, help="")  
    parser.add_argument("--batch_size", type=int, default=48, help="minibatch size")
    parser.add_argument("--GPU", type=str, default="5", help="")
    parser.add_argument("--tag", type=str, default="default", help="")
    parser.add_argument(
        "--dataset_name",
        type=str,
        default="VQA2.0",
        choices=["OKVQA", "VQA2.0"],
        help="",
    )
    parser.add_argument("--ans_atte", type=int, default=0, help="") 
    parser.add_argument(
        "--ans_inte", type=int, default=0, help="" 
    )
    parser.add_argument(
        "--input_fc_dir",
        type=str,
    ...
    parser.add_argument(
        "--input_att_dir",
        type=str,
        default="../pre-trained/coco-faster-RCNN-features/images_att",
        help="path to the directory containing the preprocessed att feats",
    )
    parser.add_argument(
        "--input_box_dir",
        type=str,
        default="../pre-trained/coco-faster-RCNN-features/images_box",
        help="path to the directory containing the boxes of att feats",
    )  
    # parser.add_argument('--input_label_h5', type=str, default='./data/question_labels.h5',
    #                 help='path to the h5file containing the preprocessed dataset')
    parser.add_argument(
        "--input_att_dir_iod",
        type=str,
        default="../VQG/Causal/unbiased-features",
    ...
    parser.add_argument(
        ...
        type=str,
        default="./data/Glove_embedding.npy",
        help="path to the glove_embedding",
    )
    parser.add_argument(
        "--visual_dict",
        type=str,
        # default='../pre-trained/coco-faster-RCNN-features/36_objects_version/objects_dict.npy',
        default="./data/vis.npy",
        help="path to the visual dict",
    )
    parser.add_argument(
        "--lin_dict",
        type=str,
        # default='../pre-trained/glove/glove_embedding.npy',
        default="./data/Glove_embedding.npy",
        help="path to the lingustic dict",
    )
    # Model settings
    parser.add_argument(
        "--vqg_model",
    ...
    parser.add_argument(
        "--glove_dim", type=int, default=300, help="the  size of the glove embedding"
    )
    parser.add_argument(
    ...
    parser.add_argument("--iod_feat_size", type=int, default=1024, help="iod")
    parser.add_argument(
    ...
    parser.add_argument(
        "--max_epochs", type=int, default=10000, help="number of epochs"
    )
    parser.add_argument(
        "--grad_clip_mode", type=str, default="value", help="value or norm"
    )
    parser.add_argument(
        "--grad_clip_value",
        type=float,
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="number of questions to sample for each image during training. Done for efficiency since CNN forward pass is expensive. E.g. coco has 5 sents/image",
    )
    ...
    parser.add_argument("--noamopt", action="store_true", default=True, help="")
    ...
    parser.add_argument(
        "--use_warmup", action="store_true", help="warm up the learing rate?"
    )
    parser.add_argument(
        "--split",
        type=str,
    ...
    parser.add_argument(
        "--self_cider_reward_weight", type=float, default=0, help="self cider reward"
    )

    # Used for self critical or structure. Used when sampling is need during training
    parser.add_argument(
        "--train_sample_n", type=int, default=5, help="The reward weight from cider"
    )
    ...
    # config
    parser.add_argument(
        "--cfg", type=str, help="configuration; similar to what is used in detectron"
    )
    parser.add_argument(
        "--set_cfgs",
        dest="set_cfgs",
    ...
    assert args.SCE > 0, "save_checkpoint_every should be greater than 0"
    ...
    args.use_fc, args.use_att = if_use_feat(args.vqg_model)
    if args.use_box:
...
def add_diversity_opts(parser):
    parser.add_argument("--sample_n", type=int, default=0, help="Diverse sampling")
    parser.add_argument(
        "--sample_n_method",
        type=str,
        default="sample",
    ...
    parser.add_argument(
        "--eval_oracle", type=int, default=1, help="if we need to calculate loss."
    )
...
def add_eval_sample_opts(parser):
    ...
    parser.add_argument(
        "--suppress_UNK", type=int, default=1, help="Not predicting UNK"
    )
